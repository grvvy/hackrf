...
from amaranth               import Elaboratable, Module, Cat, DomainRenamer, Signal, Mux
...
class Top(Elaboratable):
    ...
    def elaborate(self, platform):
        ...
        # RX decimation rate.
        m.submodules.rx_decim_cdc = cdc.FFSynchronizer(rx_decim_cic, rx_chain["cic"].factor, o_domain=adc_clk)
